...
const About = () => {
    return (
        <section className={styles.aboutCont}>
            <h1>Welcome to Fantasy Football Heroes!</h1>
            <main>
                <p>
                    At Fantasy Football Heroes, we are dedicated to bringing the excitement of fantasy football to life with a classic twist. Our platform combines the love for the game with the nostalgia of past football legends, allowing you to build your dream team using the players you know and admire.
                </p>
                <p>
